...
### Just another thing about Functions
...
::: fragment
Arguments are *lazily evaluated*. They will not compute or accessed unless needed or called.
:::
...
::: fragment
A `data.frame` in `R` is a data structure used to store data in a tabular form.
:::

::: fragment
-   think of:
    -   spreadsheet, excel sheet, SQL table

    -   collection of multiple data vectors
:::

::: fragment
It is two-dimensional, meaning it has rows and columns where:
...
-   collection of packages to help with cleaning, transformation, visualization, and analysis
:::

::: fragment
### What is `ggplot2`?

-   *the* R package for data visualization.
:::

------------------------------------------------------------------------

### Some concepts before we start -\> Publication Ready

![](images/clipboard-3308447790.png)

------------------------------------------------------------------------

### Database Ready

![](images/clipboard-3854327513.png)

------------------------------------------------------------------------

### Long vs Wide Format

![](images/clipboard-2758460241.png)
...
::: callout-note
-   Wide format is easier for human reading or performing side-by-side comparisons. This is typically the format when you are outputting a table for publications.

-   Long format is usually preferred for analysis and visualization. Ie, `ggplot2` and `dplyr` are optimized for long data (although it could work with wide with some coding variations).
:::
...
![](images/clipboard-100854897.png)
...
:::: fragment
::: callout
### Dataset 1: Road Injuries Dataset

The estimation of *Road Injuries* dataset comes from the [Global Burden of Disease](https://www.healthdata.org/research-analysis/gbd). These estimates were published in their GBD 2021 annual paper.

-   Road injuries refer to cyclist injuries, pedestrian-road injuries, motor vehicle injuries, etc.
...
::::::: fragment
:::::: callout
### Dataset 2: Overwatch Dataset

Overwatch 2 is a team-based FPS game developed by Blizzard Entertainment, typically played (5 v 5).

Each game is played within a different map and different objective.
...
-   Mode
-   Role
-   Elimination, Assists, Deaths, Damage, Heals, and Mitigation
:::
:::::
::::::
:::::::
